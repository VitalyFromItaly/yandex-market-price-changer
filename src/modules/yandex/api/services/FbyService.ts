...
export class FbyService {
    ...
    public static getOrder(
        ...
        order?: {
             ...
             *
             */
            paymentMethod: 'CASH_ON_DELIVERY' | 'CARD_ON_DELIVERY' | 'BOUND_CARD_ON_DELIVERY' | 'BNPL_BANK_ON_DELIVERY' | 'BNPL_ON_DELIVERY' | 'YANDEX' | 'YA_PLUS_POINTS' | 'APPLE_PAY' | 'EXTERNAL_CERTIFICATE' | 'CREDIT' | 'GOOGLE_PAY' | 'TINKOFF_CREDIT' | 'SBP' | 'TINKOFF_INSTALLMENTS' | 'B2B_ACCOUNT_PREPAYMENT' | 'B2B_ACCOUNT_POSTPAYMENT' | 'UNKNOWN';
            /**
             * Тип заказа:
             *
            ...
            items: Array<{
                ...
                promos?: Array<{
                     ...
                     *
                     */
                    type: 'DIRECT_DISCOUNT' | 'BLUE_SET' | 'BLUE_FLASH' | 'GENERIC_BUNDLE' | 'MARKET_COUPON' | 'MARKET_PROMOCODE' | 'MARKET_BLUE' | 'MARKET_COIN' | 'PRICE_DROP_AS_YOU_SHOP' | 'SECRET_SALE' | 'CHEAPEST_AS_GIFT' | 'CASHBACK' | 'SPREAD_DISCOUNT_COUNT' | 'SPREAD_DISCOUNT_RECEIPT' | 'DISCOUNT_BY_PAYMENT_TYPE' | 'PERCENT_DISCOUNT' | 'DCO_EXTRA_DISCOUNT' | 'UNKNOWN';
                    /**
            ...
            delivery: {
                 ...
                 *
                 */
                vat?: 'NO_VAT' | 'VAT_0' | 'VAT_10' | 'VAT_10_110' | 'VAT_20' | 'VAT_20_120' | 'VAT_18' | 'VAT_18_118' | 'VAT_12' | 'VAT_05' | 'VAT_07' | 'UNKNOWN_VALUE';
                /**
             ...
             *
             */
            taxSystem: 'OSN' | 'USN' | 'USN_MINUS_COST' | 'ENVD' | 'ECHN' | 'PSN' | 'NPD' | 'UNKNOWN_VALUE';
            /**
             * **Только для модели DBS**
             *
             * Запрошена ли отмена.
    ...
    public static getOfferMappingEntries(
        ...
        status?: Array<'UNKNOWN' | 'READY' | 'IN_WORK' | 'NEED_INFO' | 'NEED_MAPPING' | 'NEED_CONTENT' | 'CONTENT_PROCESSING' | 'SUSPENDED' | 'REJECTED' | 'REVIEW' | 'CREATE_ERROR' | 'UPDATE_ERROR'>,
    ...
    public static getSuggestedOfferMappingEntries(
        ...
        requestBody: {
            ...
            offers: Array<{
                 ...
                 */
                supplyScheduleDays?: Array<'MONDAY' | 'TUESDAY' | 'WEDNESDAY' | 'THURSDAY' | 'FRIDAY' | 'SATURDAY' | 'SUNDAY'> | null;
                /**
                ...
                processingState?: {
                    ...
                    notes?: Array<{
                         ...
                         */
                        type?: 'ASSORTMENT' | 'CANCELLED' | 'CONFLICTING_INFORMATION' | 'OTHER' | 'DEPARTMENT_FROZEN' | 'INCORRECT_INFORMATION' | 'LEGAL_CONFLICT' | 'NEED_CLASSIFICATION_INFORMATION' | 'NEED_INFORMATION' | 'NEED_PICTURES' | 'NEED_VENDOR' | 'NO_CATEGORY' | 'NO_KNOWLEDGE' | 'NO_PARAMETERS_IN_SHOP_TITLE' | 'NO_SIZE_MEASURE' | 'SAMPLE_LINE';
                        /**
    ...
    public static getOrdersStats(
        ...
        requestBody?: {
             ...
             */
            statuses?: Array<'CANCELLED_BEFORE_PROCESSING' | 'CANCELLED_IN_DELIVERY' | 'CANCELLED_IN_PROCESSING' | 'DELIVERY' | 'DELIVERED' | 'PARTIALLY_DELIVERED' | 'PARTIALLY_RETURNED' | 'PENDING' | 'PICKUP' | 'PROCESSING' | 'RESERVED' | 'RETURNED' | 'UNKNOWN' | 'UNPAID' | 'LOST'> | null;
            /**
     ...
     *
     * @param requestBody
     * @returns any Отчет по товарам.
     * @throws ApiError
     */
    public static getGoodsStats(
        campaignId: number,
        requestBody: {
            /**
             ...
             *
             */
            shopSkus: Array<paths_1campaigns_1_campaignId_1hidden_offers_get_parameters_1_schema_items>;
        },
    ): CancelablePromise<paths_1warehouses_get_responses_200_content_application_1json_schema_allOf_0> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/campaigns/{campaignId}/stats/skus',
            path: {
                'campaignId': campaignId,
            },
            body: requestBody,
    ...
    public static generateUnitedReturnsReport(
        requestBody: {
             ...
             *
             */
            returnStatusTypes?: Array<'CREATED' | 'RECEIVED' | 'IN_TRANSIT' | 'READY_FOR_PICKUP' | 'PICKED' | 'LOST' | 'EXPIRED' | 'CANCELLED' | 'FULFILMENT_RECEIVED' | 'PREPARED_FOR_UTILIZATION' | 'NOT_IN_DEMAND' | 'UTILIZED' | 'READY_FOR_EXPROPRIATION' | 'RECEIVED_FOR_EXPROPRIATION' | 'UNKNOWN'> | null;
        },
        format: 'FILE' | 'CSV' | 'JSON' = 'FILE',
    ): CancelablePromise<paths_1reports_1prices_1generate_post_responses_200_content_application_1json_schema> {
        return __request(OpenAPI, {
    ...
    public static getCampaignOffers(
        ...
        requestBody: {
             ...
             *
             */
            statuses?: Array<'PUBLISHED' | 'CHECKING' | 'DISABLED_BY_PARTNER' | 'DISABLED_AUTOMATICALLY' | 'REJECTED_BY_MARKET' | 'CREATING_CARD' | 'NO_CARD' | 'NO_STOCKS' | 'ARCHIVED'> | null;
            /**
             * Фильтр по категориям на Маркете.
             */
            categoryIds?: Array<number> | null;
    ...
    public static getOfferCardsContentStatus(
        ...
        requestBody?: {
             ...
             *
             */
            cardStatuses?: Array<'HAS_CARD_CAN_NOT_UPDATE' | 'HAS_CARD_CAN_UPDATE' | 'HAS_CARD_CAN_UPDATE_ERRORS' | 'HAS_CARD_CAN_UPDATE_PROCESSING' | 'NO_CARD_NEED_CONTENT' | 'NO_CARD_MARKET_WILL_CREATE' | 'NO_CARD_ERRORS' | 'NO_CARD_PROCESSING' | 'NO_CARD_ADD_TO_CAMPAIGN'> | null;
            /**
             * Фильтр по категориям на Маркете.
             */
            categoryIds?: Array<number> | null;
     ...
     * @throws ApiError
     */
    public static calculateTariffs(
        requestBody: {
            /**
     ...
     * @throws ApiError
     */
    public static getCategoriesTree(
        requestBody?: {
            /**
             * Язык категорий.
             */
     ...
     * @throws ApiError
     */
    public static getCategoriesMaxSaleQuantum(
        requestBody: {
            /**
