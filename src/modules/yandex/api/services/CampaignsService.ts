...
export class CampaignsService {
   ...
   * @throws ApiError
   */
  public static getCampaign(campaignId: number): CancelablePromise<{
    /**
     * Информация о магазине.
     */
    campaign?: {
   ...
   * @throws ApiError
   */
  public static getCampaignSettings(campaignId: number): CancelablePromise<{
    /**
     * Настройки магазина.
     */
    settings?: {
   ...
   * @throws ApiError
   */
  public static getCampaignRegion(campaignId: number): CancelablePromise<{
