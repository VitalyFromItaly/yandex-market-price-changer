...
export const MENU_LAYOUT: readonly (readonly TMenuLabel[])[] = [
  ...
  [MENU.PROFIT],
  // Склады — своим рядом: это не срез заказов, а справка по инфраструктуре.
  // Фича по умолчанию выключена, поэтому featureMenuLayout убирает этот ряд у
  // всех, кому её не открыли, и пустого ряда не остаётся (ряд схлопывается).
  [MENU.WAREHOUSES],
