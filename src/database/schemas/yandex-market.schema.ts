...
export class YandexMarket {
   ...
   * цены товара). У обеих форм может быть необязательный `from` — нижний
   * порог, цена, с которой продвижение начисляется; дешевле — 0 %.
   * Отсутствие ключа = продвижение не настроено = 0 %: буст
